...
export default function SideRail({ onRecipesClick, onSettingsClick, onAiClick, onXrayClick, onHistoryClick, onBookmarksClick, onNotesClick, onDevToolsClick, onReaderMode, onScreenshot, recipeCount, xrayActive }: Props) {
  return (
    <div className="side-rail">
      <div className="rail-top">
        ...
        <button className="rail-btn" onClick={onNotesClick} aria-label="Notes" title="Page Notes">
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
